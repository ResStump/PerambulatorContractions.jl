...
# doublets and sparse modes where the contractions are done in parallel on each MPI rank
# using Distributed.jl.
#
# Usage:
#   dad-DD_local-nonlocal_mixed_distributed.jl -i <parms file>
#
        ...
        contractions = (τ_charm, τ, Φ, x_sink, v_sink) -> begin
            ...
            for Iₚ_nonlocal in Iₚ_nonlocal_arr
                ...
                C_nl, C_ln = PC.DD_dad_nonlocal_local_mixed_contractons(
                    ...
                    (x_sink, x_src_μiₓ_t₀, v_sink, v_src_ciₓk_t₀),
